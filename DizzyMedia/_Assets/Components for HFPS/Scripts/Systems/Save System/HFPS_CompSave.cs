...
namespace DizzyMedia.HFPS_Components {
    ...
    /////////////////
            ...
            CurLevel_Set(SceneManager.GetActiveScene().name);
    ...
    ///////////////
        ...
        public bool IsCurLevel_Check(){
            ...
            if(Get_CurLevel() == SceneManager.GetActiveScene().name){
            
                return true;
                
            }//curLevel = active scene
        
            return false;
        
        }//IsCurLevel_Check
        
        public void CurLevel_Set(string scene = ""){
        
            if(scene != ""){
            
                if(saveData.levelData.curLevel != scene){
        
                    saveData.levelData.curLevel = scene;
    ...
    //////////////////////////
        ...
        public string Get_CurLevel(){
        
            return saveData.levelData.curLevel;
