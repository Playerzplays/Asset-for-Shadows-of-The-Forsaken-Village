...
namespace DizzyMedia.Shared {
    ...
    //////////////////////////
        ...
        public override void OnInspectorGUI() {
            ...
            SerializedProperty saveTime = serializedObject.FindProperty("saveTime");
                    ...
                    if(hfpsCharAct.userOptions.actionAttribute == HFPS_CharacterAction.ActionAttribute.Teleport){
                        ...
                        if(hfpsCharAct.teleportType == HFPS_CharacterAction.Teleport_Type.Level){
                            ...
                            if(showTips){
                                ...
                                EditorGUILayout.HelpBox("\n" + "The point in which the save will trigger for this action." + "\n", MessageType.Info);

                                EditorGUILayout.Space();

                            }//showTips

                            EditorGUILayout.PropertyField(saveTime, true);
                            hfpsCharAct.preLoadScene = EditorGUILayout.Toggle("Pre Load Scene?", hfpsCharAct.preLoadScene);
