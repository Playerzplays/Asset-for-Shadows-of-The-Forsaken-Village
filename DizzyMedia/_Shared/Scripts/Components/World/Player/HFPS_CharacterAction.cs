            ...
            if(userOptions.actionAttribute == ActionAttribute.Teleport){
                ...
                if(teleportType == Teleport_Type.Level){
                    ...
                    if(saveState == Save_State.Active){
                        ...
                        if(saveTime == Save_Time.ActionStart){

                            auto.uiCont.Save_Init(preLoadScene);

                        }//saveTime = action start
                    ...
                    if(userOptions.actionAttribute == ActionAttribute.Teleport){
                        ...
                        if(teleportType == Teleport_Type.Level){
                            ...
                            if(saveState == Save_State.Active){
                                ...
                                if(saveTime == Save_Time.ActionStartEnd){

                                    auto.uiCont.Save_Init(preLoadScene);
                                
                                }//saveTime = action start end
